...
type Tab = 'profile' | 'projects' | 'skills' | 'site'

export function ContentEditor({
  profile, projects, skills, siteConfig,
  ...
  const TAB_LABELS: Record<Tab, string> = {
    profile: '个人资料', projects: '项目管理', skills: '技能管理', site: '站点设置',
  }
    ...
    <div className={styles.editor}>
      ...
      {tab === 'site' && (
        <div className={styles.form}>
          ...
          <label>页脚文字</label>
          <input className={styles.input} value={sc.footer_text} onChange={(e) => setSc({ ...sc, footer_text: e.target.value })} placeholder="Built with ❤️ and Claude Code." />
